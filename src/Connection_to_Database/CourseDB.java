...
public static void addingStudents(CourseDB sbs) throws SQLException{
    ...
    sbs.statement.addBatch("CREATE TABLE STUDENTS_INFO (STUDENT_ID INT, F_NAME VARCHAR(50), L_NAME VARCHAR(50),ADDRESS VARCHAR(50),PHONE_NUMBER VARCHAR(50))");
...
public static void addingCourses(CourseDB sbs) throws SQLException{
    ...
    sbs.statement.addBatch("CREATE TABLE COURSES(COURSE_CODE VARCHAR(50), COURSE_NAME VARCHAR(50), PRICE FLOAT, YEARS_FOR_COURSE VARCHAR(50), SEMESTER VARCHAR(50))");
